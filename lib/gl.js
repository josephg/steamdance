  ...
  constructor(canvas, view) {
    ...
    const init = () => {
      this.gridShader = compileProgram(gl, ['proj', 'tile'], ['pos'], {
        vertex: glslify(__dirname + '/grid.vertex.glsl'),
        fragment: glslify(__dirname + '/grid.fragment.glsl'),
      });
      this.shuttleShader = compileProgram(gl, ['proj', 'color'], ['pos'], {
        // These shaders are super generic.
        vertex: glslify(__dirname + '/shuttle.vertex.glsl'),
        fragment: glslify(__dirname + '/shuttle.fragment.glsl'),
      });
